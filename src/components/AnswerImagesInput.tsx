...
export const AnswerImagesInput: React.FC<AnswerImagesInputProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<"zip" | "files" | "imgbb">("zip");
  ...
  return (
    <div id="answer-images-panel" className="bg-white dark:bg-neutral-900 rounded-2xl border border-neutral-200 dark:border-neutral-800 shadow-xs p-3.5 sm:p-5 flex flex-col h-full transition-colors">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3.5">
        ...
        {/* Source Switcher: Equal 3-col grid on mobile so no button is ever cut off */}
      ...
      <div className="mb-4">
        {activeTab === "zip" && (
          <div
            ...
            className="border-2 border-dashed border-neutral-300 dark:border-neutral-700 hover:border-blue-500 hover:bg-blue-50/40 dark:hover:bg-blue-950/30 rounded-xl p-4 text-center cursor-pointer transition-all flex flex-col items-center justify-center min-h-[110px]"
          >
            <input
              ref={zipInputRef}
              type="file"
            ...
            {isExtractingZip ? (
              ...
              <>
                ...
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
                  Easily unpacks 1, 10, or 30-40 answer screenshots instantly
                </p>
              </>
            )}
          </div>
        ...
        {activeTab === "files" && (
          ...
          >
            ...
            <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">
              Select or Drop Multiple Screenshots
            </p>
            <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-0.5">
              Hold Ctrl/Cmd or Shift to select multiple image files
            </p>
          </div>
        )}
