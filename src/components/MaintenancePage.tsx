    ...
    >
      ...
      >
        ...
        <div className="pt-4 border-t border-neutral-800/80 flex items-center justify-between text-xs text-neutral-500">
          ...
          <button
            id="maintenance-to-admin-btn"
            type="button"
            onClick={onGoToAdmin}
            className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 transition-colors font-semibold cursor-pointer"
          >
